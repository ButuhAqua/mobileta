...
class InventoryGerobakEPage extends StatefulWidget {
  const InventoryGerobakEPage({super.key});

  @override
  State<InventoryGerobakEPage> createState() => _InventoryGerobakEPageState();
}

class _InventoryGerobakEPageState extends State<InventoryGerobakEPage> {
  static const Color kPrimary = Color(0xFF00695C);
  ...
  Future<void> _loadInventory() async {
    ...
    setState(() {
      _futureInventory = getInventoryByLocation('Gerobak E', token);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Inventory Produk — Gerobak E'),
