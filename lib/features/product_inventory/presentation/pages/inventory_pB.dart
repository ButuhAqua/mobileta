...
class InventoryGerobakBPage extends StatefulWidget {
  const InventoryGerobakBPage({super.key});

  @override
  State<InventoryGerobakBPage> createState() => _InventoryGerobakBPageState();
}

class _InventoryGerobakBPageState extends State<InventoryGerobakBPage> {
  static const Color kPrimary = Color(0xFF388E3C); // Hijau untuk Gerobak B
  ...
  Future<void> _loadInventory() async {
    ...
    setState(() {
      _futureInventory = getInventoryByLocation('Gerobak B', token);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Inventory Produk — Gerobak B'),
