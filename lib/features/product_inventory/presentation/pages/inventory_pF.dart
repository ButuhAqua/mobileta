...
class InventoryGerobakFPage extends StatefulWidget {
  const InventoryGerobakFPage({super.key});

  @override
  State<InventoryGerobakFPage> createState() => _InventoryGerobakFPageState();
}

class _InventoryGerobakFPageState extends State<InventoryGerobakFPage> {
  static const Color kPrimary = Color(0xFFE65100);
  ...
  Future<void> _loadInventory() async {
    ...
    setState(() {
      _futureInventory = getInventoryByLocation('Gerobak F', token);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Inventory Produk — Gerobak F'),
