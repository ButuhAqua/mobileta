...
class InventoryGerobakCPage extends StatefulWidget {
  const InventoryGerobakCPage({super.key});

  @override
  State<InventoryGerobakCPage> createState() => _InventoryGerobakCPageState();
}

class _InventoryGerobakCPageState extends State<InventoryGerobakCPage> {
  static const Color kPrimary = Color(0xFFF57C00); // Orange untuk Gerobak C
  ...
  Future<void> _loadInventory() async {
    ...
    setState(() {
      _futureInventory = getInventoryByLocation('Gerobak C', token);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Inventory Produk — Gerobak C'),
